...
import { Activity, BellRing, BrainCircuit, Fuel, Gauge, HeartPulse, LockKeyhole, MapPinned, RadioTower, Route, ShieldAlert } from "lucide-react";
import FeatureCard from "@/components/FeatureCard";
import SectionHeader from "@/components/SectionHeader";
import CTASection from "@/components/CTASection";
import FleetVisualShowcase from "@/components/FleetVisualShowcase";

export const metadata: Metadata = {
  title: "Fleet Management Features",
  description: "Explore LAS Mobility features including live tracking, geofencing, route history, alerts, fuel analytics, driver behavior, reports, immobilization, device health, and AI insights."
};
...
const features = [
  ...
  { icon: BellRing, title: "Alerts", description: "Configure actionable notifications for overspeeding, geofence entry or exit, device issues, route deviation, idling, and safety events." },
